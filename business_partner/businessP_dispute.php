...
if (!isset($_SESSION['user_id']) || $_SESSION['account_type'] !== 'business partner') {
...
<style>
  * {
  ...
  .greeting-wrapper {
    ...
    z-index: 1; /* Ensure it stays below the user info when opened */
  }
  ...
  <div class="some-page-wrapper">
    ...
    <div class="row">
      <div class="left-column">
        <a href="businessP_dashboard.php" class="<?php echo ($current_page == 'businessP_dashboard') ? 'active' : ''; ?>">Dashboard</a>
        <a href="businessP_products.php" class="<?php echo ($current_page == 'businessP_products') ? 'active' : ''; ?>">Products</a>
        <a href="businessP_history.php" class="<?php echo ($current_page == 'businessP_history') ? 'active' : ''; ?>">History</a>
        <a href="businessP_cart.php" class="<?php echo ($current_page == 'businessP_cart') ? 'active' : ''; ?>">Cart</a>
        <a href="businessP_dispute.php" class="<?php echo ($current_page == 'businessP_dispute') ? 'active' : ''; ?>">Dispute</a>
      </div>

      <div class="right-column">
        <div>
          <h1>Welcome to the Partner Dashboard</h1>
