...
if (!isset($_SESSION['user_id']) || $_SESSION['account_type'] !== 'farmer') {
  ...
  <div class="some-page-wrapper">
    ...
    <div class="row">
      <div class="left-column">
        <a href="farmer_dashboard.php" class="<?php echo ($current_page == 'farmer_dashboard') ? 'active' : ''; ?>">Dashboard</a>
        <a href="farmer_harvest.php" class="<?php echo ($current_page == 'farmer_harvest') ? 'active' : ''; ?>">Harvest</a>
        <a href="farmer_delivery.php" class="<?php echo ($current_page == 'farmer_delivery') ? 'active' : ''; ?>">Delivery</a>
        <a href="farmer_inventory.php" class="<?php echo ($current_page == 'farmer_inventory') ? 'active' : ''; ?>">Inventory</a>
        <a href="farmer_disputes.php" class="<?php echo ($current_page == 'farmer_disputes') ? 'active' : ''; ?>">Disputes</a>
      </div>
